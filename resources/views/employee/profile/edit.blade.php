            ...
            <div class="p-3 card-body">
                <form method="post" id="userInfo" enctype="multipart/form-data">
                    ...
                    <div class="mb-2 form-group">
                        ...
                        @enderror
                        <img src="{{ asset('user/img/'.$user->picture) }}" alt="Profile" height="80px" width="90px" class="mt-2">
                    </div>
                    ...
                    <!-- Department -->
                    <div class="mb-2 form-group">
                        <label for="department">{{ __('Qualification') }}</label>
                        <select id="department" name="qualification" class="form-control">
                    ...
                    <!-- Designation -->
                    <div class="mb-2 form-group">
                        <label for="designation">{{ __('Experience') }}</label>
